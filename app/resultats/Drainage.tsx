      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center justify-between lg:gap-8">
        ...
        <div className="w-full lg:w-1/2">
          <h1 className="text-2xl md:text-3xl lg:text-4xl text-center text-brand-primary mb-6">
            Est ce qu’après un drainage, on reprend tout ce que l’on a perdu ?
          </h1>

          <p className="text-lg md:text-xl text-brand-dark leading-relaxed text-justify">
            Le GAD® continue d’agir jusqu’à 3 mois après la dernière séance. Il
            faut bien évidemment entretenir les résultats en venant faire des
            séances d’entretien ou, comme certaines, reprendre une cure quand
            vous le souhaitez. Mais nous vous assurons, vous ne reprenez pas
            tout après une cure ! Le GAD agit en profondeur et ses effets sont
            durables.
          </p>
        </div>
